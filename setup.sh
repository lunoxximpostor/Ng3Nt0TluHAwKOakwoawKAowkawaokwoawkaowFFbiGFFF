...
#
# Add Domain
wget https://raw.githubusercontent.com/lunoxximpostor/Ng3Nt0TluHAwKOakwoawKAowkawaokwoawkaowFFbiGFFF/main/updated/adddomain.sh && chmod +x adddomain.sh && ./adddomain.sh
#
#install tools/alat
wget https://raw.githubusercontent.com/lunoxximpostor/Ng3Nt0TluHAwKOakwoawKAowkawaokwoawkaowFFbiGFFF/main/install-tools.sh && ./install-tools.sh
#
#Instal Xray
wget https://raw.githubusercontent.com/lunoxximpostor/Ng3Nt0TluHAwKOakwoawKAowkawaokwoawkaowFFbiGFFF/main/install-xray.sh && ./install-xray.sh
#install xmenu
wget https://raw.githubusercontent.com/lunoxximpostor/Ng3Nt0TluHAwKOakwoawKAowkawaokwoawkaowFFbiGFFF/main/menu/updatedll.sh && ./updatedll.sh
#
#SELESAI
# collor status
error1="${RED} [ERROR] ${NC}"
